              ...
              candidatures.map((candidature) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p><strong>Durée:</strong> {candidature.Offre.Durée}</p>
                    <p><strong>Période:</strong> {candidature.Offre.Période}</p>
                    <h4>Informations sur l'entreprise</h4>
                    <p><strong>Nom:</strong> {candidature.Offre.Company.Nom_Entreprise}</p>
                    <p><strong>Adresse:</strong> {candidature.Offre.Company.Adresse_Entreprise}</p>
                    <p><strong>Téléphone:</strong> {candidature.Offre.Company.Tel_Entreprise}</p>
                    <p><strong>Email:</strong> {candidature.Offre.Company.Email_Entreprise}</p>
